...
function Hero() {
    return (
        <div className="bg-gradient-to-br from-blue-50 to-cyan-50 py-16 px-5 text-center border-b border-blue-200">
            ...
            <a href={appUrl('/tournaments')} className="inline-block px-8 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold cursor-pointer text-base hover:from-blue-700 hover:to-cyan-600 rounded-lg shadow-lg transition-all transform hover:scale-105">
                Prejsť na turnaje
            </a>
        </div>
    );
